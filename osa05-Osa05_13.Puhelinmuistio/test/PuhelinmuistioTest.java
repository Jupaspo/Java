...
public class PuhelinmuistioTest {
    ...
    @Points("05-13.1")
    @Test
    public void henkilonMetodiGetNimi() throws Throwable {
        ...
        assertEquals("Tarkasta koodi h = new Henkilo(\"Pekka\", \"040-123654\"); "
                + "h.getNimi();", "Pekka", klass.method(olio, metodi)
        ...
        assertEquals("Tarkasta koodi h = new Henkilo(\"Jukka\", \"040-123654\"); "
                + "h.getNimi();", "Jukka", klass.method(olio, metodi)
                        .returning(String.class).takingNoParams().withNiceError(v).invoke());
    }

    @Points("05-13.1")
    @Test
    public void henkilonMetodiGetNumero() throws Throwable {
        String metodi = "getNumero";
        ...
        assertEquals("Tarkasta koodi h = new Henkilo(\"Pekka\", \"040-123654\"); "
                + "h.getNumero();", "040-123654", klass.method(olio, metodi)
                        .returning(String.class).takingNoParams().withNiceError(v).invoke());
        ...
        assertEquals("Tarkasta koodi h = new Henkilo(\"Pekka\", \"040-333444\"); "
                + "h.getNumero();", "040-333444", klass.method(olio, metodi)
                        .returning(String.class).takingNoParams().withNiceError(v).invoke());
    }
    ...
    public void henkilonMetodiVaihdaNumeroa() throws Throwable {
        ...
        v = "Toimiiko metodi vaihdaNumeroa oikein?\n"
                ...
                + "h.vaihdaNumero(\"050-444666\"); h.getNumero()";

        assertEquals(v, "050-444666", klass.method(olio, "getNumero")
                .returning(String.class).takingNoParams().withNiceError(v).invoke());
